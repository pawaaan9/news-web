  ...
  return (
    <div className="w-full bg-accent-teal rounded-lg p-4 shadow-sm">
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
        <h2 className="text-lg md:text-xl font-bold mb-3 md:mb-0 text-white">
          {title}
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-4">
        <div className="bg-gray-50 p-3 rounded flex items-center">
          ...
          <div className="flex flex-col">
            ...
            <a
              href={`mailto:${email}`}
              className="text-sm text-charcoal font-bold hover:underline"
            >
              {email}
            </a>
          </div>
        ...
        <div className="bg-gray-50 p-3 rounded flex items-center">
          ...
          <div className="flex flex-col">
            ...
            <a
              href={`tel:${phone}`}
              className="text-sm text-charcoal hover:underline font-bold"
            >
              {phone}
            </a>
          </div>
